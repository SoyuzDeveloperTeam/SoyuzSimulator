...
// UI_forMM.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CUIforMMApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CUIforMMApp::OnAppAbout)
...
// Создание CUIforMMApp

CUIforMMApp::CUIforMMApp() noexcept
{
	...
	SetAppID(_T("UIforMM.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CUIforMMApp

CUIforMMApp theApp;


// Инициализация CUIforMMApp

BOOL CUIforMMApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_UIforMMTYPE,
		RUNTIME_CLASS(CUIforMMDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(CUIforMMView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CUIforMMApp
...
void CUIforMMApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CUIforMMApp

void CUIforMMApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CUIforMMApp::LoadCustomState()
{
}

void CUIforMMApp::SaveCustomState()
{
}
